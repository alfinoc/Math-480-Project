...
\caption{A sample randomly generated preference map for one TA. Lighter colors represent preferred time slots, while darker slots are less prefered. Completely backed out time slots are those in which the TA cannot work at all. Note that several hours on Monday, Wednesday, and Friday are blacked out (mimicking a typical UW schedule) and that typical preferences center around a ``favorite'' time slot.}
\end{figure*}
